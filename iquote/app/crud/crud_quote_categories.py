...
class CRUDQuoteCategories(
    ...
    # def get_by_parent_name(self, db: Session, *, parent_name: str) -> List[QuoteCategories]:
    #     return db.query(QuoteCategories).filter(QuoteCategories.parent_id == parent_id).all()
